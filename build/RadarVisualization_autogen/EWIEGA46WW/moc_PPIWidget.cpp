...
static constexpr auto qt_meta_stringdata_ZN9PPIWidgetE = QtMocHelpers::stringData(
    "PPIWidget"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN9PPIWidgetE[] = {
...
Q_CONSTINIT const QMetaObject PPIWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN9PPIWidgetE.offsetsAndSizes,
    qt_meta_data_ZN9PPIWidgetE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN9PPIWidgetE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<PPIWidget, std::true_type>
    >,
    nullptr
} };
...
void *PPIWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN9PPIWidgetE.stringdata0))
